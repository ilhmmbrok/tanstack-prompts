  ...
  ],
  {
    variants: {
      ...
      size: {
        ...
        'xs-icon':
          'size-7.5 rounded-sm after:rounded-sm [&>svg:not([class*=size-])]:size-4',
        sm: 'h-8.5 px-3 rounded after:rounded [&>svg:not([class*=size-])]:size-4.5',
        'sm-icon':
          'size-8.5 rounded after:rounded [&>svg:not([class*=size-])]:size-4.5',
        ...
        'lg-icon':
          'size-11.5 rounded-lg after:rounded-lg [&>svg:not([class*=size-])]:size-4.5',
      },
      pill: {

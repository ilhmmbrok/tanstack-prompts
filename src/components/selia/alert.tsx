  ...
  ],
  {
    variants: {
      variant: {
        ...
        danger:
          'bg-danger/7 ring ring-danger/30 [&_svg:not([class*=text-])]:text-danger',
        info: 'bg-info/7 ring ring-info/30 [&_svg:not([class*=text-])]:text-info',
        success:
          'bg-success/7 ring ring-success/30 [&_svg:not([class*=text-])]:text-success',
        warning:
          'bg-warning/7 ring ring-warning/30 [&_svg:not([class*=text-])]:text-warning',
        tertiary:
          'bg-tertiary/7 ring ring-tertiary/30 [&_svg:not([class*=text-])]:text-tertiary',
      },
    },
    defaultVariants: {
      variant: 'default',
